...
$data.InMemoryConverter={fromDb:{"$data.Byte":$data.Container.proxyConverter,"$data.SByte":$data.Container.proxyConverter,"$data.Decimal":$data.Container.proxyConverter,"$data.Float":$data.Container.proxyConverter,"$data.Int16":$data.Container.proxyConverter,"$data.Int64":$data.Container.proxyConverter,"$data.Integer":$data.Container.proxyConverter,"$data.Number":$data.Container.proxyConverter,"$data.Date":$data.Container.proxyConverter,"$data.DateTimeOffset":$data.Container.proxyConverter,"$data.Time":$data.Container.proxyConverter,
"$data.String":$data.Container.proxyConverter,"$data.Boolean":$data.Container.proxyConverter,"$data.Blob":$data.Container.proxyConverter,"$data.Object":function(b){return void 0===b?new $data.Object:b},"$data.Array":function(b){return void 0===b?new $data.Array:b},"$data.Guid":function(b){return b?$data.parseGuid(b).toString():b},"$data.GeographyPoint":function(b){return b?new $data.GeographyPoint(b):b},"$data.GeographyLineString":function(b){return b?new $data.GeographyLineString(b):b},"$data.GeographyPolygon":function(b){return b?
new $data.GeographyPolygon(b):b},"$data.GeographyMultiPoint":function(b){return b?new $data.GeographyMultiPoint(b):b},"$data.GeographyMultiLineString":function(b){return b?new $data.GeographyMultiLineString(b):b},"$data.GeographyMultiPolygon":function(b){return b?new $data.GeographyMultiPolygon(b):b},"$data.GeographyCollection":function(b){return b?new $data.GeographyCollection(b):b},"$data.GeometryPoint":function(b){return b?new $data.GeometryPoint(b):b},"$data.GeometryLineString":function(b){return b?
new $data.GeometryLineString(b):b},"$data.GeometryPolygon":function(b){return b?new $data.GeometryPolygon(b):b},"$data.GeometryMultiPoint":function(b){return b?new $data.GeometryMultiPoint(b):b},"$data.GeometryMultiLineString":function(b){return b?new $data.GeometryMultiLineString(b):b},"$data.GeometryMultiPolygon":function(b){return b?new $data.GeometryMultiPolygon(b):b},"$data.GeometryCollection":function(b){return b?new $data.GeometryCollection(b):b}},toDb:{"$data.Byte":$data.Container.proxyConverter,
"$data.SByte":$data.Container.proxyConverter,"$data.Decimal":$data.Container.proxyConverter,"$data.Float":$data.Container.proxyConverter,"$data.Int16":$data.Container.proxyConverter,"$data.Int64":$data.Container.proxyConverter,"$data.Integer":$data.Container.proxyConverter,"$data.Number":$data.Container.proxyConverter,"$data.Date":$data.Container.proxyConverter,"$data.DateTimeOffset":$data.Container.proxyConverter,"$data.Time":$data.Container.proxyConverter,"$data.String":$data.Container.proxyConverter,
"$data.Boolean":$data.Container.proxyConverter,"$data.Blob":$data.Container.proxyConverter,"$data.Object":$data.Container.proxyConverter,"$data.Array":$data.Container.proxyConverter,"$data.Guid":function(b){return b?b.toString():b},"$data.GeographyPoint":function(b){return b},"$data.GeographyLineString":function(b){return b},"$data.GeographyPolygon":function(b){return b},"$data.GeographyMultiPoint":function(b){return b},"$data.GeographyMultiLineString":function(b){return b},"$data.GeographyMultiPolygon":function(b){return b},
"$data.GeographyCollection":function(b){return b},"$data.GeometryPoint":function(b){return b},"$data.GeometryLineString":function(b){return b},"$data.GeometryPolygon":function(b){return b},"$data.GeometryMultiPoint":function(b){return b},"$data.GeometryMultiLineString":function(b){return b},"$data.GeometryMultiPolygon":function(b){return b},"$data.GeometryCollection":function(b){return b}},escape:{"$data.Byte":$data.Container.proxyConverter,"$data.SByte":$data.Container.proxyConverter,"$data.Decimal":$data.Container.proxyConverter,
"$data.Float":$data.Container.proxyConverter,"$data.Int16":$data.Container.proxyConverter,"$data.Int64":$data.Container.proxyConverter,"$data.Integer":$data.Container.proxyConverter,"$data.Number":$data.Container.proxyConverter,"$data.Date":function(b){return b?"new Date(Date.parse('"+b.toISOString()+"'))":b},"$data.DateTimeOffset":function(b){return b?"new Date(Date.parse('"+b.toISOString()+"'))":b},"$data.Time":function(b){return b?"new Date(Date.parse('"+b.toISOString()+"'))":b},"$data.String":function(b){return"'"+
b.replace(/'/g,"''")+"'"},"$data.Boolean":function(b){return b?"true":"false"},"$data.Blob":function(b){return"'"+$data.Blob.toString(b)+"'"},"$data.Object":function(b){return JSON.stringify(b)},"$data.Array":function(b){return JSON.stringify(b)},"$data.Guid":function(b){return b?"'"+b.toString()+"'":b}}};
$data.mongoDBConverter={fromDb:{"$data.Byte":$data.Container.proxyConverter,"$data.SByte":$data.Container.proxyConverter,"$data.Decimal":$data.Container.proxyConverter,"$data.Float":$data.Container.proxyConverter,"$data.Int16":$data.Container.proxyConverter,"$data.Int64":$data.Container.proxyConverter,"$data.Integer":$data.Container.proxyConverter,"$data.Number":$data.Container.proxyConverter,"$data.Date":function(b){return b?new Date(b):b},"$data.DateTimeOffset":function(b){return b?new Date(b):
b},"$data.Time":function(b){return b?new Date(b):b},"$data.String":$data.Container.proxyConverter,"$data.Boolean":$data.Container.proxyConverter,"$data.Blob":function(b){return b?$data.Container.convertTo(b.buffer,$data.Blob):b},"$data.Object":function(b){return void 0===b?new $data.Object:b},"$data.Array":function(b){return void 0===b?new $data.Array:b},"$data.ObjectID":function(b){return b?(new Buffer(b.toString(),"ascii")).toString("base64"):b},"$data.GeographyPoint":function(b){return b?new $data.GeographyPoint(b):
b},"$data.GeographyLineString":function(b){return b?new $data.GeographyLineString(b):b},"$data.GeographyPolygon":function(b){return b?new $data.GeographyPolygon(b):b},"$data.GeographyMultiPoint":function(b){return b?new $data.GeographyMultiPoint(b):b},"$data.GeographyMultiLineString":function(b){return b?new $data.GeographyMultiLineString(b):b},"$data.GeographyMultiPolygon":function(b){return b?new $data.GeographyMultiPolygon(b):b},"$data.GeographyCollection":function(b){return b?new $data.GeographyCollection(b):
b},"$data.GeometryPoint":function(b){return b?new $data.GeometryPoint(b):b},"$data.GeometryLineString":function(b){return b?new $data.GeometryLineString(b):b},"$data.GeometryPolygon":function(b){return b?new $data.GeometryPolygon(b):b},"$data.GeometryMultiPoint":function(b){return b?new $data.GeometryMultiPoint(b):b},"$data.GeometryMultiLineString":function(b){return b?new $data.GeometryMultiLineString(b):b},"$data.GeometryMultiPolygon":function(b){return b?new $data.GeometryMultiPolygon(b):b},"$data.GeometryCollection":function(b){return b?
new $data.GeometryCollection(b):b},"$data.Guid":function(b){return b?$data.parseGuid(b).toString():b}},toDb:{"$data.Byte":$data.Container.proxyConverter,"$data.SByte":$data.Container.proxyConverter,"$data.Decimal":$data.Container.proxyConverter,"$data.Float":$data.Container.proxyConverter,"$data.Int16":$data.Container.proxyConverter,"$data.Int64":$data.Container.proxyConverter,"$data.Integer":$data.Container.proxyConverter,"$data.Number":$data.Container.proxyConverter,"$data.Date":$data.Container.proxyConverter,
"$data.DateTimeOffset":$data.Container.proxyConverter,"$data.Time":$data.Container.proxyConverter,"$data.String":$data.Container.proxyConverter,"$data.Boolean":$data.Container.proxyConverter,"$data.Blob":$data.Container.proxyConverter,"$data.Object":$data.Container.proxyConverter,"$data.Array":$data.Container.proxyConverter,"$data.ObjectID":function(b){if(b&&"string"===typeof b)try{return new $data.ObjectID(b)}catch(a){try{return new $data.ObjectID((new Buffer(b,"base64")).toString("ascii"))}catch(c){return console.log(c),
b}}else return b},"$data.GeographyPoint":function(b){return b?b.coordinates:b},"$data.GeographyLineString":$data.Container.proxyConverter,"$data.GeographyPolygon":$data.Container.proxyConverter,"$data.GeographyMultiPoint":$data.Container.proxyConverter,"$data.GeographyMultiLineString":$data.Container.proxyConverter,"$data.GeographyMultiPolygon":$data.Container.proxyConverter,"$data.GeographyCollection":$data.Container.proxyConverter,"$data.GeometryPoint":function(b){return b?b.coordinates:b},"$data.GeometryLineString":$data.Container.proxyConverter,
"$data.GeometryPolygon":$data.Container.proxyConverter,"$data.GeometryMultiPoint":$data.Container.proxyConverter,"$data.GeometryMultiLineString":$data.Container.proxyConverter,"$data.GeometryMultiPolygon":$data.Container.proxyConverter,"$data.GeometryCollection":$data.Container.proxyConverter,"$data.Guid":function(b){return b?b.toString():b}}};
...
a.cursor.push(e)):a.cursor[a.queryField]=a.unary===$data.Expressions.ExpressionType.Not?{$ne:a.value}:a.value;a.options.fields&&(a.options.fields[a.queryField]=1);a.unary===$data.Expressions.ExpressionType.Not&&(a.unary=void 0);break;case $data.Expressions.ExpressionType.In:this.Visit(b.left,a);this.Visit(b.right,a);a.queryField=a.field;!a.complexType&&a.entityType&&a.entityType.memberDefinitions.getMember(a.field).computed&&(delete a.query[a.field],a.queryField="_id");c=a.value;if(c instanceof Array){c=
c.map(function(a){return a.value});for(d=0;d<c.length;d++)a.entityType&&a.entityType.memberDefinitions?c[d]=this.provider.fieldConverter.toDb[Container.resolveName(Container.resolveType(a.entityType.memberDefinitions.getMember(a.complexType?a.lastField:a.field).type))](c[d]):a.valueType&&(c[d]=this.provider.fieldConverter.toDb[Container.resolveName(Container.resolveType(a.valueType))](c[d]))}a.value=c;a.cursor instanceof Array?(e={},e[a.queryField]={},a.entityType&&a.entityType===$data.Array?e[a.queryField]=
a.unary===$data.Expressions.ExpressionType.Not?{$not:a.value}:a.value:e[a.queryField][a.unary===$data.Expressions.ExpressionType.Not?"$nin":b.resolution.mapTo]=a.value,a.cursor.push(e)):(a.cursor[a.queryField]={},a.entityType&&a.entityType===$data.Array?a.cursor[a.queryField]=a.unary===$data.Expressions.ExpressionType.Not?{$not:a.value}:a.value:a.cursor[a.queryField][a.unary===$data.Expressions.ExpressionType.Not?"$nin":b.resolution.mapTo]=a.value);a.options.fields&&(a.options.fields[a.queryField]=
...
(a.cursor[a.queryField]={},a.cursor[a.queryField][b.resolution.mapTo]=a.value);a.options.fields&&(a.options.fields[a.queryField]=1)}delete a.complexType;delete a.association;delete a.field;delete a.value},VisitEntityFieldExpression:function(b,a){this.Visit(b.source,a);this.Visit(b.selector,a)},VisitAssociationInfoExpression:function(b,a){this.includes=this.includes||[];for(var c=(a.include?a.include.name+"."+b.associationInfo.FromPropertyName:b.associationInfo.FromPropertyName).split("."),d=null,
e=this.mainEntitySet.entityContext._storageModel.getStorageModel(this.mainEntitySet.createNew),f=0;f<c.length;f++){d=d?d+("."+c[f]):c[f];if(e=e.Associations[c[f]]){var g=this.includes.filter(function(a){return a.name==d},this);a.include&&f<c.length-1&&(a.include.options.fields||(a.include.options.fields={_id:1}),a.include.options.fields[c[f+1]]=1);g.length?(a.includeOptions=g[0].options,a.include=g[0]):(g={name:d,type:e.ToType,from:e.FromType,query:{},options:{},mapped:!1},a.includeOptions=g.options,
...
a){a.data+=b.value}});
$C("$data.storageProviders.mongoDB.mongoDBFunctionCompiler",$data.Expressions.EntityExpressionVisitor,null,{constructor:function(b){this.provider=b},compile:function(b,a){this.Visit(b,a)},VisitParametricQueryExpression:function(b,a){this.Visit(b.expression,a)},VisitUnaryExpression:function(b,a){a.data+=this.provider.supportedBinaryOperators[b.resolution.name].mapTo;a.data+="(";this.Visit(b.operand,a);a.data+=")"},VisitSimpleBinaryExpression:function(b,a){b.resolution.reverse?(a.data+="(",this.Visit(b.right,
a),a.data+=this.provider.supportedBinaryOperators[b.resolution.name].mapTo,this.Visit(b.left,a),b.resolution.rightValue&&(a.data+=b.resolution.rightValue)):(a.data+="(",this.Visit(b.left,a),a.data+=this.provider.supportedBinaryOperators[b.resolution.name].mapTo,this.Visit(b.right,a));a.data+=")"},VisitConstantExpression:function(b,a){var c=Container.resolveType(b.type),c=Container.resolveName(c);a.data+=this.provider.fieldConverter.toDb[c](b.value)},VisitMemberInfoExpression:function(b,a){a.data+=
b.memberDefinition.computed?"_id":b.memberName},VisitComplexTypeExpression:function(b,a){this.Visit(b.source,a);this.Visit(b.selector,a);a.data+="."},VisitEntityExpression:function(b,a){this.Visit(b.source,a);a.entityType=b.entityType;b.selector.lambda&&(a.data+=b.selector.lambda+".",a.lambda=b.selector.lambda)},VisitEntitySetExpression:function(b,a){this.Visit(b.source,a);b.selector instanceof $data.Expressions.AssociationInfoExpression&&this.Visit(b.selector,a)},VisitObjectLiteralExpression:function(b,
a){a.data+="{ ";for(var c=0;c<b.members.length;c++){var d=b.members[c];0<c&&(a.data+=", ");this.Visit(d,a)}a.data+=" }"},VisitObjectFieldExpression:function(b,a){a.data+=b.fieldName+": ";this.Visit(b.expression,a)},VisitAssociationInfoExpression:function(b,a){a.data+=b.associationInfo.FromPropertyName+"."},VisitEntityFieldOperationExpression:function(b,a){Guard.requireType("expression.operation",b.operation,$data.Expressions.MemberInfoExpression);var c=b.operation.memberDefinition,c=this.provider.supportedFieldOperations[c.name];
c.propertyFunction&&(this.Visit(b.source,a),a.data+=".");a.data+=c.mapTo||c.name;var d=0;(c.parameters||[]).map(function(a){return a.name==="@expression"?b.source:b.parameters[d++]}).forEach(function(b,c){if(b){if(c>0)a.data=a.data+",";this.Visit(b,a)}},this);a.data+=c.rightValue||""}});
...
dataType:"string"}]},endsWith:{mapTo:"$data.StringFunctions.endsWith(",rightValue:")",dataType:"boolean",parameters:[{name:"@expression",dataType:"string"},{name:"strFragment",dataType:"string"}]}},fieldConverter:{toDb:$data.InMemoryConverter.escape}})).compile(b.selector,a),a.filter=new Function(a.lambda,"return "+a.data+";"),a.data="",a.lambda="")},VisitProjectionExpression:function(b,a){this.Visit(b.source,a);(new $data.storageProviders.mongoDB.mongoDBProjectionCompiler(this.provider,null,this)).compile(b,
a)},VisitIncludeExpression:function(b,a){this.Visit(b.source,a);this.includes=this.includes||[];for(var c=b.selector.value.split("."),d=null,e=this.mainEntitySet.entityContext._storageModel.getStorageModel(this.mainEntitySet.createNew),f=0;f<c.length;f++){d=d?d+("."+c[f]):c[f];if(e=e.Associations[c[f]]){var g=this.includes.filter(function(a){return a.name==d},this);g.length?g[0].mapped=!0:this.includes.push({name:d,type:e.ToType,from:e.FromType,query:{},options:{},mapped:!0})}else Guard.raise(new Exception("The given include path is invalid: "+
b.selector.value+", invalid point: "+d));e=this.mainEntitySet.entityContext._storageModel.getStorageModel(e.ToType)}},VisitInlineCountExpression:function(){this.query.withInlineCount=!0}});
...
k.FromPropertyName,k.From,b._id,k)})[0],a[h]=b||a[h])},n=function(a,b){for(var c=!0,d=0;d<b.length;d++){"undefined"!==typeof a[b[d]]&&(a=a[b[d]]);if(Array.isArray(a)&&a.length)for(var c=!1,e=0;e<a.length;e++)d<b.length-1?n(a[e],b.slice(d)):t(a[e]);if(!c)break}c&&t(a)},r=0;r<d.length;r++)n(d[r],i.slice(0,-1));if(b.options.sort){i=Object.keys(b.options.sort);for(r=i.length-1;0<=r;r--){var p=new Function("it","return it."+i[r]+";");b.options.sort[i[r]]?d.sort(function(a,b){var c=p(a),d=p(b);return c===
d?0:c<d?1:-1}):result.sort(function(a,b){var c=p(a),d=p(b);return c===d?0:c>d?1:-1})}}j&&j.length?e(j.shift()):l(f,d)}})};j&&j.length?e(j.shift()):l(b,d)}})};b.withInlineCount?g.find({},{}).count(function(c,f){e?a.error(e):(b.__count=f,d())}):d()}};c.providerConfiguration.username?f.authenticate(c.providerConfiguration.username,c.providerConfiguration.password,function(b,c){b?a.error(b):c?h():a.error("Authentication failed")}):h()}})},_typeFactory:function(b,a,c){if(a&&a.$ref&&a.$id||null==a||void 0==
a)return a;b=Container.resolveName(b);return c&&c[b]?c[b](a):new (Container.resolveType(b))(a)},_saveCollections:function(b,a){var c=this,d=0,e=this._getServer(),f=0,g=function(a){0>=--f&&a()},j=function(a,e,f){for(var g=[],j=0;j<e.insertAll.length;j++){for(var h=e.insertAll[j],q=Container.resolveType(h.type).memberDefinitions.getPublicMappedProperties(),m=0;m<q.length;m++){var k=q[m];k.concurrencyMode===$data.ConcurrencyMode.Fixed?h.data[k.name]=0:k.computed?h.data._id=c._typeFactory(k.type,h.data._id,
c.fieldConverter.toDb):(h.data[k.name]=c._typeFactory(k.type,h.data[k.name],c.fieldConverter.toDb),h.data[k.name]&&h.data[k.name].initData&&(h.data[k.name]=h.data[k.name].initData))}g.push(h.data)}f.insert(g,{safe:!0},function(g,h){if(g)b.error(g),a.close();else{for(var k=0;k<h.length;k++)for(var j=h[k],v=e.insertAll[k],u=Container.resolveType(v.type).memberDefinitions.getPublicMappedProperties(),m=0;m<u.length;m++){var o=u[m];o.inverseProperty||(v.entity[o.name]=c._typeFactory(o.type,j[o.computed?
"_id":o.name],c.fieldConverter.fromDb))}d+=h.length;e.removeAll&&e.removeAll.length?l(a,e,f):e.updateAll&&e.updateAll.length?i(a,e,f):p(a,d)}})},i=function(a,e,h){f=e.updateAll.length;for(var j=0;j<e.updateAll.length;j++){for(var i=e.updateAll[j],l={},q=Container.resolveType(i.type).memberDefinitions.getKeyProperties(),m=0;m<q.length;m++){var k=q[m];l[k.computed?"_id":k.name]=c.fieldConverter.toDb[Container.resolveName(Container.resolveType(k.type))](i.entity[k.name])}for(var s={},q=Container.resolveType(i.type).memberDefinitions.getPublicMappedProperties(),
m=0;m<q.length;m++){var n=q[m];if(0<=i.entity.changedProperties.indexOf(n))if(n.concurrencyMode===$data.ConcurrencyMode.Fixed)l[n.name]=c._typeFactory(n.type,i.data[n.name],c.fieldConverter.toDb),s.$inc||(s.$inc={}),s.$inc[n.name]=1;else if(!n.computed&&"undefined"!==typeof i.data[n.name])if(Container.resolveType(n.type)===$data.Array&&n.elementType&&Container.resolveType(n.elementType)===$data.ObjectID){s[n.name]=c._typeFactory(n.type,i.data[n.name],c.fieldConverter.toDb);var r=s[n.name];if(r)for(k=
0;k<r.length;k++)r[k]=c._typeFactory(n.elementType,r[k],c.fieldConverter.toDb)}else s[n.name]=c._typeFactory(n.type,i.data[n.name],c.fieldConverter.toDb)}(function(e){h.update(l,{$set:s},{safe:!0},function(k,j){if(k)b.error(k),a.close();else if(j){d++;for(var i=Container.resolveType(e.type).memberDefinitions.getPublicMappedProperties(),m=0;m<i.length;m++){var n=i[m];n.concurrencyMode===$data.ConcurrencyMode.Fixed&&e.entity[n.name]++}g(function(){p(a,d)})}else f--,h.find({_id:l._id},{}).toArray(function(f,
h){if(f)b.error(f);else{for(var k=h[0],i=Container.resolveType(e.type).memberDefinitions.getPublicMappedProperties(),j=0;j<i.length;j++){var l=i[j];e.entity[l.name]=c._typeFactory(l.type,k[l.computed?"_id":l.name],c.fieldConverter.fromDb)}g(function(){p(a,d)})}})})})(i)}},l=function(a,e,h){f=e.removeAll.length;for(var j=0;j<e.removeAll.length;j++){var l=e.removeAll[j],o;for(o in l.data)(void 0===l.data[o]||null===l.data[o])&&delete l.data[o];var q=Container.resolveType(l.type).memberDefinitions.getKeyProperties();
for(o=0;o<q.length;o++){var m=q[o];l.data[m.computed?"_id":m.name]=c.fieldConverter.toDb[Container.resolveName(Container.resolveType(m.type))](l.entity[m.name])}q=Container.resolveType(l.type).memberDefinitions.getPublicMappedProperties();for(o=0;o<q.length;o++)m=q[o],m.key||delete l.data[m.name];h.remove(l.data,{safe:!0},function(c,j){c?(b.error(c),a.close()):(j?d++:f--,g(function(){e.updateAll&&e.updateAll.length?i(a,e,h):p(a,d)}))})}},h=Object.keys(a),p=function(d,e){if(h.length){var f=h.pop();
if(a.hasOwnProperty(f)){var g=a[f],f=new c.driver.Collection(d,f);g.insertAll&&g.insertAll.length?j(d,g,f):g.removeAll&&g.removeAll.length?l(d,g,f):g.updateAll&&g.updateAll.length?i(d,g,f):(b.success(0),d.close())}}else b.success(e),d.close()};(new this.driver.Db(this.providerConfiguration.databaseName,e,{safe:!1})).open(function(a,d){a?b.error(a):c.providerConfiguration.username?d.authenticate(c.providerConfiguration.username,c.providerConfiguration.password,function(a,c){a?b.error(a):c&&p(d)}):
p(d)})},saveChanges:function(b,a){var c=this;if(a.length){var d=this.buildIndependentBlocks(a),e=[],f=0,g=function(a){for(var i={},l=0;l<a.length;l++){e.push(a[l].data);var h=i[a[l].entitySet.name];h||(h={},i[a[l].entitySet.name]=h);var p={entity:a[l].data,data:c.save_getInitData(a[l],e),type:Container.resolveName(a[l].data.getType())};switch(a[l].data.entityState){case $data.EntityState.Unchanged:continue;case $data.EntityState.Added:h.insertAll||(h.insertAll=[]);h.insertAll.push(p);break;case $data.EntityState.Modified:h.updateAll||
(h.updateAll=[]);h.updateAll.push(p);break;case $data.EntityState.Deleted:h.removeAll||(h.removeAll=[]);h.removeAll.push(p);break;default:Guard.raise(new Exception("Not supported Entity state"))}}c._saveCollections({success:function(a){f+=a;d.length?g(d.shift()):b.success(f)},error:b.error},i)};d.length&&g(d.shift())}else b.success(0)},buildDbType_generateConvertToFunction:function(b){var a=this;return function(c){var d=new b.PhysicalType;d.entityState=c.entityState;b.PhysicalType.memberDefinitions.getPublicMappedProperties().forEach(function(a){d.initData[a.name]=
c[a.name]},this);b.Associations&&b.Associations.forEach(function(b){if("*"==b.FromMultiplicity&&"0..1"==b.ToMultiplicity||"0..1"==b.FromMultiplicity&&"1"==b.ToMultiplicity){var f=c[b.FromPropertyName];void 0!==f&&b.ReferentialConstraint.forEach(function(c){null!==f?(d.initData[b.FromPropertyName]={$ref:a._entitySetReferences[b.To].tableName,$id:a.storageProvider._typeFactory(f.getType().memberDefinitions.getMember(c[b.To]).type,f[c[b.To]],a.storageProvider.fieldConverter.toDb)},d.initData[c[b.From]]=
a.storageProvider._typeFactory(f.getType().memberDefinitions.getMember(c[b.To]).type,f[c[b.To]],a.storageProvider.fieldConverter.toDb)):(d.initData[b.FromPropertyName]=null,d.initData[c[b.From]]=null)},this)}},this);b.ComplexTypes&&b.ComplexTypes.forEach(function(b){d.initData[b.FromPropertyName]=a.storageProvider._typeFactory(b.ToType,c[b.FromPropertyName],a.storageProvider.fieldConverter.toDb)},this);return d}},buildDbType_modifyInstanceDefinition:function(b,a){var c=function(a,b,c,g){var j={};
j[a.name]=c;j[b.name]=g+"__"+c;return j};a.Associations&&a.Associations.forEach(function(a){var e=!1,f=a.FromType,g=a.ToType,j=a.ToPropertyName;a.ReferentialConstraint=a.ReferentialConstraint||[];if("*"==a.FromMultiplicity&&"0..1"==a.ToMultiplicity||"0..1"==a.FromMultiplicity&&"1"==a.ToMultiplicity)f=a.ToType,g=a.FromType,j=a.FromPropertyName,e=!0;f.memberDefinitions.getPublicMappedProperties().filter(function(a){return a.key}).forEach(function(i){if(e){var l=j+"__"+i.name,h;j?(h=JSON.parse(JSON.stringify(b[j])),
h.kind=i.kind,h.name=i.name,h.notMapped=!1):h=JSON.parse(JSON.stringify(i));h.dataType=Container.resolveType(i.dataType);h.type=h.dataType;h.key=!1;h.computed=!1;b[l]=h}a.ReferentialConstraint.push(c(f,g,i.name,j))},this)},this)},save_getInitData:function(b,a){b.physicalData=this.context._storageModel.getStorageModel(b.data.getType()).PhysicalType.convertTo(b.data,a);var c={};b.physicalData.getType().memberDefinitions.asArray().forEach(function(a){if(a.kind==$data.MemberTypes.navProperty||a.kind==
$data.MemberTypes.complexProperty||a.kind==$data.MemberTypes.property&&!a.notMapped)c[a.computed?"_id":a.name]=b.physicalData[a.name]},this);return c},supportedDataTypes:{value:[$data.Integer,$data.String,$data.Number,$data.Blob,$data.Boolean,$data.Date,$data.ObjectID,$data.Object,$data.GeographyPoint,$data.Guid,$data.GeographyLineString,$data.GeographyPolygon,$data.GeographyMultiPoint,$data.GeographyMultiLineString,$data.GeographyMultiPolygon,$data.GeographyCollection,$data.GeometryPoint,$data.GeometryLineString,
$data.GeometryPolygon,$data.GeometryMultiPoint,$data.GeometryMultiLineString,$data.GeometryMultiPolygon,$data.GeometryCollection,$data.Byte,$data.SByte,$data.Decimal,$data.Float,$data.Int16,$data.Int64,$data.Time,$data.DateTimeOffset],writable:!1},supportedBinaryOperators:{value:{equal:{mapTo:":",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression]},notEqual:{mapTo:"$ne",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression]},equalTyped:{mapTo:":",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression]},
