...
new $data.GeometryLineString(a):a},"$data.GeometryPolygon":function(a){return a?new $data.GeometryPolygon(a):a},"$data.GeometryMultiPoint":function(a){return a?new $data.GeometryMultiPoint(a):a},"$data.GeometryMultiLineString":function(a){return a?new $data.GeometryMultiLineString(a):a},"$data.GeometryMultiPolygon":function(a){return a?new $data.GeometryMultiPolygon(a):a},"$data.GeometryCollection":function(a){return a?new $data.GeometryCollection(a):a}},toDb:{"$data.Byte":$data.Container.proxyConverter,
...
"$data.Boolean":$data.Container.proxyConverter,"$data.Blob":$data.Container.proxyConverter,"$data.Object":$data.Container.proxyConverter,"$data.Array":$data.Container.proxyConverter,"$data.Guid":function(a){return a?a.toString():a},"$data.GeographyPoint":function(a){return a},"$data.GeographyLineString":function(a){return a},"$data.GeographyPolygon":function(a){return a},"$data.GeographyMultiPoint":function(a){return a},"$data.GeographyMultiLineString":function(a){return a},"$data.GeographyMultiPolygon":function(a){return a},
"$data.GeographyCollection":function(a){return a},"$data.GeometryPoint":function(a){return a},"$data.GeometryLineString":function(a){return a},"$data.GeometryPolygon":function(a){return a},"$data.GeometryMultiPoint":function(a){return a},"$data.GeometryMultiLineString":function(a){return a},"$data.GeometryMultiPolygon":function(a){return a},"$data.GeometryCollection":function(a){return a}},escape:{"$data.Byte":$data.Container.proxyConverter,"$data.SByte":$data.Container.proxyConverter,"$data.Decimal":$data.Container.proxyConverter,
"$data.Float":$data.Container.proxyConverter,"$data.Int16":$data.Container.proxyConverter,"$data.Int64":$data.Container.proxyConverter,"$data.Integer":$data.Container.proxyConverter,"$data.Number":$data.Container.proxyConverter,"$data.Date":function(a){return a?"new Date(Date.parse('"+a.toISOString()+"'))":a},"$data.DateTimeOffset":function(a){return a?"new Date(Date.parse('"+a.toISOString()+"'))":a},"$data.Time":function(a){return a?"new Date(Date.parse('"+a.toISOString()+"'))":a},"$data.String":function(a){return"'"+
a.replace(/'/g,"''")+"'"},"$data.Boolean":function(a){return a?"true":"false"},"$data.Blob":function(a){return"'"+$data.Blob.toString(a)+"'"},"$data.Object":function(a){return JSON.stringify(a)},"$data.Array":function(a){return JSON.stringify(a)},"$data.Guid":function(a){return a?"'"+a.toString()+"'":a}}};
...
b=[],c;for(c in this.context._entitySetReferences)b.push(this.context._entitySetReferences[c].collectionName);var e=null;if(this.providerConfiguration.persistentData&&window.localStorage&&this.providerConfiguration.dbCreation!==$data.storageProviders.DbCreationType.DropAllExistingTables)var d=this,e=JSON.parse(window.localStorage.getItem(this.providerConfiguration.databaseName||"JayData_InMemory_Provider"),function(a,c){return-1<b.indexOf(a)&&c.map?c.map(function(b){return new d.context[a].createNew(b)}):
c});var f=e||this.providerConfiguration.source||{};this.providerConfiguration.source={inmemory_sequence:{}};for(var h=0;h<this.context._storageModel.length;h++){var g=this.context._storageModel[h];this.providerConfiguration.source[g.TableName]=[];var j=g.LogicalType.memberDefinitions.getKeyProperties().filter(function(a){return a.computed});1<j.length&&Guard.raise(new Exception("More than one computed field not supported in "+g.TableName+" entity set."));var k=!1;1===j.length&&(c=Container.resolveName(j[0].type),
!0===this.supportedAutoincrementKeys[c]?(this.providerConfiguration.source.inmemory_sequence[g.TableName]=0,k=!0):"function"!==typeof this.supportedAutoincrementKeys[c]&&console.log("WARRNING! '"+c+"' not supported as computed Key!"));if(f[g.TableName])for(c=0;c<f[g.TableName].length;c++){var i=f[g.TableName][c];i instanceof g.LogicalType||(e?i=new g.LogicalType(i):Guard.raise(new Exception("Invalid element in source: "+g.TableName)));if(k){var l=i[j[0].name];l>this.providerConfiguration.source.inmemory_sequence[g.TableName]&&
(this.providerConfiguration.source.inmemory_sequence[g.TableName]=l)}this.providerConfiguration.source[g.TableName].push(i)}}a.success(this.context)},executeQuery:function(a,b){var b=$data.typeSystem.createCallbackSetting(b),c;try{c=this._compile(a)}catch(e){b.error(e);return}var d=[].concat(this.providerConfiguration.source[a.context.getEntitySetFromElementType(a.defaultType).tableName]||[]);c.$filter&&!c.$every&&(d=d.filter(c.$filter));c.$map&&0===Object.keys(a.modelBinderConfig).length&&(d=d.map(c.$map));
if(c.$order&&0<c.$order.length){c.$order.reverse();for(var f=0,h=c.$order.length;f<h;f++)c.$order[f].ASC?d.sort(function(a,b){var d=c.$order[f](a),e=c.$order[f](b);return d===e?0:d>e?1:-1}):d.sort(function(a,b){var d=c.$order[f](a),e=c.$order[f](b);return d===e?0:d<e?1:-1})}void 0!==c.$take&&void 0!==c.$skip?d=d.slice(c.$skip,c.$skip+c.$take):void 0!==c.$take&&d.length>c.$take?d=d.slice(0,c.$take):c.$skip&&(d=d.slice(c.$skip,d.length));c.$some&&(d=[0<d.length]);c.$length&&(d=[d.length]);a.rawDataList=
d;b.success(a)},_compile:function(a){return(new $data.storageProviders.InMemory.InMemoryCompiler(this)).compile(a)},saveChanges:function(a,b){for(var c=0;c<b.length;c++){var e=b[c];switch(e.data.entityState){case $data.EntityState.Added:this._save_add_processPk(e);this.providerConfiguration.source[e.entitySet.tableName].push(e.data);break;case $data.EntityState.Deleted:var d=this.providerConfiguration.source[e.entitySet.tableName],f=this._save_getEntity(e,d),e=d.indexOf(f);d.splice(e,1);break;case $data.EntityState.Modified:if(e.data.changedProperties&&
0<e.data.changedProperties.length){d=this.providerConfiguration.source[e.entitySet.tableName];f=this._save_getEntity(e,d);for(d=0;d<e.data.changedProperties.length;d++){var h=e.data.changedProperties[d];!h.key&&-1<e.entitySet.elementType.memberDefinitions.getPublicMappedPropertyNames().indexOf(h.name)&&(f[h.name]=e.data[h.name])}}}}this.providerConfiguration.persistentData&&window.localStorage&&(localStorageData=window.localStorage.setItem(this.providerConfiguration.databaseName||"JayData_InMemory_Provider",
JSON.stringify(this.providerConfiguration.source)));a.success()},_save_add_processPk:function(a){var b=a.entitySet.elementType.memberDefinitions.getKeyProperties();if(1===b.length&&b[0].computed){var b=b[0],c=Container.resolveName(b.type);"function"===typeof this.supportedAutoincrementKeys[c]?a.data[b.name]=this.supportedAutoincrementKeys[c]():!0===this.supportedAutoincrementKeys[c]&&(c=this.providerConfiguration.source.inmemory_sequence[a.entitySet.tableName],a.data[b.name]=c+1,this.providerConfiguration.source.inmemory_sequence[a.entitySet.tableName]=
c+1)}else for(c=0;c<b.length;c++)(null===a.data[b[c].name]||void 0===a.data[b[c].name])&&Guard.raise(new Exception("Key field must set value! Key field name without value: "+b[c].name))},_save_getEntity:function(a,b){var c=a.entitySet.elementType.memberDefinitions.getKeyProperties();entities=b.filter(function(b){for(var d=!0,f=0;f<c.length;f++)d=d&&b[c[f].name]===a.data[c[f].name];return d});1<entities&&Guard.raise(new Exception("Inconsistent storage!"));return entities[0]},getTraceString:function(a){return this._compile(a)},
supportedDataTypes:{value:[$data.Integer,$data.String,$data.Number,$data.Blob,$data.Boolean,$data.Date,$data.Object,$data.Guid,$data.GeographyPoint,$data.GeographyLineString,$data.GeographyPolygon,$data.GeographyMultiPoint,$data.GeographyMultiLineString,$data.GeographyMultiPolygon,$data.GeographyCollection,$data.GeometryPoint,$data.GeometryLineString,$data.GeometryPolygon,$data.GeometryMultiPoint,$data.GeometryMultiLineString,$data.GeometryMultiPolygon,$data.GeometryCollection,$data.Byte,$data.SByte,
$data.Decimal,$data.Float,$data.Int16,$data.Int64,$data.Time,$data.DateTimeOffset],writable:!1},supportedBinaryOperators:{value:{equal:{mapTo:" == ",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression,$data.Expressions.OrderExpression]},notEqual:{mapTo:" != ",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression,$data.Expressions.OrderExpression]},equalTyped:{mapTo:" === ",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression,$data.Expressions.OrderExpression]},
notEqualTyped:{mapTo:" !== ",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression,$data.Expressions.OrderExpression]},greaterThan:{mapTo:" > ",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression,$data.Expressions.OrderExpression]},greaterThanOrEqual:{mapTo:" >= ",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression,$data.Expressions.OrderExpression]},lessThan:{mapTo:" < ",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression,$data.Expressions.OrderExpression]},
lessThenOrEqual:{mapTo:" <= ",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression,$data.Expressions.OrderExpression]},or:{mapTo:" || ",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression,$data.Expressions.OrderExpression]},and:{mapTo:" && ",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression,$data.Expressions.OrderExpression]},"in":{mapTo:".indexOf(",allowedIn:[$data.Expressions.FilterExpression],rightValue:") > -1",reverse:!0}}},supportedUnaryOperators:{value:{not:{mapTo:"!"}}},
supportedFieldOperations:{value:{contains:{mapTo:"$data.StringFunctions.contains(",rightValue:")",dataType:"boolean",parameters:[{name:"@expression",dataType:"string"},{name:"strFragment",dataType:"string"}]},startsWith:{mapTo:"$data.StringFunctions.startsWith(",rightValue:")",dataType:"boolean",parameters:[{name:"@expression",dataType:"string"},{name:"strFragment",dataType:"string"}]},endsWith:{mapTo:"$data.StringFunctions.endsWith(",rightValue:")",dataType:"boolean",parameters:[{name:"@expression",
dataType:"string"},{name:"strFragment",dataType:"string"}]},length:{dataType:"number",propertyFunction:!0},substr:{mapTo:"substr(",rightValue:")",dataType:"string",parameters:[{name:"startFrom",dataType:"number"},{name:"length",dataType:"number"}],propertyFunction:!0},toLowerCase:{dataType:"string",mapTo:"toLowerCase()",propertyFunction:!0},toUpperCase:{dataType:"string",mapTo:"toUpperCase()",propertyFunction:!0},trim:{dataType:$data.String,mapTo:"trim()",propertyFunction:!0},ltrim:{dataType:$data.String,
mapTo:"trimLeft()",propertyFunction:!0},rtrim:{dataType:$data.String,mapTo:"trimRight()",propertyFunction:!0}},enumerable:!0,writable:!0},supportedSetOperations:{value:{filter:{},map:{},length:{},forEach:{},toArray:{},single:{},some:{},take:{},skip:{},orderBy:{},orderByDescending:{},first:{}},enumerable:!0,writable:!0},fieldConverter:{value:$data.InMemoryConverter},supportedAutoincrementKeys:{value:{"$data.Integer":!0,"$data.Guid":function(){return $data.createGuid()}}}},null);
...
b){b.data+=a.memberName},VisitComplexTypeExpression:function(a,b){this.Visit(a.source,b);this.Visit(a.selector,b);b.data+="."},VisitEntityExpression:function(a,b){b.data+=a.selector.lambda+".";b.lambda=a.selector.lambda;this.Visit(a.source,b)},VisitEntitySetExpression:function(){},VisitObjectLiteralExpression:function(a,b){b.data+="{ ";for(var c=0;c<a.members.length;c++){var e=a.members[c];0<c&&(b.data+=", ");this.Visit(e,b)}b.data+=" }"},VisitObjectFieldExpression:function(a,b){b.data+=a.fieldName+
